...
BEST_PARAMS = dict(
    n_estimators=342, max_depth=17, max_features=0.5554,
...
plt.tight_layout()
plt.savefig('rf_pred_cv.png', dpi=200, bbox_inches='tight')
plt.close()
...
ax.grid(True, alpha=0.25)
plt.tight_layout()
plt.savefig('rf_pred_test.png', dpi=200, bbox_inches='tight')
plt.close()
...
ax.grid(True, alpha=0.25)
plt.tight_layout()
plt.savefig('rf_residuals.png', dpi=200, bbox_inches='tight')
plt.close()
...
ax.grid(True, alpha=0.25)
plt.tight_layout()
plt.savefig('rf_residuals_hist.png', dpi=200, bbox_inches='tight')
plt.close()
...
ax.grid(True, alpha=0.25)
plt.tight_layout()
plt.savefig('rf_qq.png', dpi=200, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('rf_shap.png', dpi=200, bbox_inches='tight')
plt.close()
...
for tr, val in skf.split(X_train, strat_bins_train):
    m = clone(best_pipe)
    m.fit(X_train[tr], y_train[tr])
    fold_r2.append(r2_score(y_train[val], m.predict(X_train[val])))
...
plt.tight_layout()
plt.savefig('rf_cv_folds.png', dpi=200, bbox_inches='tight')
plt.close()

print("\nSaved figures:")
for f in ['rf_pred_cv.png', 'rf_pred_test.png', 'rf_residuals.png',
          'rf_residuals_hist.png', 'rf_qq.png', 'rf_shap.png', 'rf_cv_folds.png']:
    print(f"  {f}")
